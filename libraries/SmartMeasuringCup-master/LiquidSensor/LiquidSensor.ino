...
#define ZERO_VOLUME_RESISTANCE    2800    // Resistance value (in ohms) when no liquid is present.
#define CALIBRATION_RESISTANCE    700    // Resistance value (in ohms) when liquid is at max line.
#define CALIBRATION_VOLUME        5000    // Volume (in any units) when liquid is at max line.
