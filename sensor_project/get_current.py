...
#
# DESC:
# Get data from the CT(Current Transformer) Sensor. Compare the current power with the 
# previous power data to determine if the status of the pump. Store the status and current
# time into remote database for furthur uses.
# 
# DATE:
# 06/03/2014
#
